...
export class TriangleColorPicker extends PureComponent {
    ...
    _getColor() {
        const passedColor = typeof this.props.color === 'string' ? tinycolor(this.props.color).toHsv() : this.props.color;
    ...
    render() {
        ...
        return (_jsxs(View, { style: style, children: [_jsx(View, { onLayout: this._onLayout, ref: this.pickerContainer, style: styles.pickerContainer, children: !pickerSize ? null : (_jsxs(View, { children: [_jsxs(View, { style: [styles.triangleContainer, computed.triangleContainer], children: [_jsx(View, { style: [styles.triangleUnderlayingColor, computed.triangleUnderlayingColor] }), _jsx(Image, { style: [/* styles.triangleImage, */ computed.triangleImage], source: require('./resources/hsv_triangle_mask.png') })] }, rotationHack), _jsxs(View, { ...this._pickerResponder.panHandlers, style: [/* styles.picker, */ computed.picker], collapsable: false, children: [_jsx(Image, { source: require('./resources/color-circle.png'), resizeMode: "contain", style: [styles.pickerImage] }), _jsx(View, { style: [styles.pickerIndicator, computed.pickerIndicator], children: _jsx(View, { style: [styles.pickerIndicatorTick, computed.pickerIndicatorTick] }) }, rotationHack), _jsx(View, { style: [styles.svIndicator, computed.svIndicator] })] })] })) }), _jsxs(View, { style: [styles.colorPreviews, computed.colorPreviews], children: [oldColor && (_jsx(TouchableOpacity, { style: [styles.colorPreview, { backgroundColor: oldColor }], onPress: this._onOldColorSelected, activeOpacity: 0.7 })), _jsx(TouchableOpacity, { style: [styles.colorPreview, { backgroundColor: selectedColor }], onPress: this._onColorSelected, activeOpacity: 0.7 })] })] }));
    }
}
