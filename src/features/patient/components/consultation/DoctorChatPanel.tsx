...
export interface DoctorChatPanelProps {
  visible: boolean;
  ...
  return (
    <Modal visible={visible} animationType="slide" onRequestClose={onClose}>
      <SafeAreaView className="flex-1 bg-white" edges={['top', 'bottom']}>
        <View className="bg-primary-50 px-4 pb-4 pt-2">
          <View className="flex-row items-center gap-4">
            ...
            <View className="gap-0.5">
              <Text className="text-c1 font-semibold font-sans text-text-primary">{doctorName}</Text>
                <Text className="text-[10px] font-sans text-text-secondary">{t('consultation.online')}</Text>
              </View>
            </View>
        ...
        <View className="flex-row justify-end px-4 pb-2 pt-6">
          <View className="h-10 flex-row items-center gap-2 rounded-md border border-grey-300 bg-grey-50 px-2.5">
        ...
        <View className="mx-3 mb-4 rounded-2xl border border-grey-300 bg-white px-4 py-3">
          <TextInput
            ...
            placeholder={t('consultation.doctorInputPlaceholder')}
