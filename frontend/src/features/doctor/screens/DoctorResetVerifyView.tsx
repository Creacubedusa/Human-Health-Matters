...
import { useDoctorResetVerify } from '../hooks/useDoctorResetVerify';
import { useAuthStore } from '@shared/store/auth.store';

const CODE_LENGTH = 6;

export interface DoctorResetVerifyViewProps {
  onSuccess: () => void;
}
...
export function DoctorResetVerifyView({ onSuccess }: DoctorResetVerifyViewProps) {
